...
int main() {
  vll f = {1,2,3,4,5};               // index 0 is always 0
  FenwickTree ft(f);
...
//   printf("%lld\n", ft.rsq(1, 10)); // now 12
  ...
  RUPQ rupq(10);
  RURQ rurq(10);
  rupq.range_update(1, 4, 10); // indices in [2, 3, .., 9] updated by +7
//   rurq.range_update(2, 9, 7); // same as rupq above
//   rupq.range_update(1, 10, 3); // indices 6&7 are further updated by +3 (10)
